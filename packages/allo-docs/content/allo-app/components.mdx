...
<Cards>
  <Cards.Card
    ...
    href="/contracts/pool#registrationform"
  />
  <Cards.Card
    icon={<Rows3 />}
    title="ApplicationsList"
    href="/contracts/pool#applicationslist"
  />
  <Cards.Card
    icon={<LayoutGrid />}
    title="ProjectsGrid"
    href="/contracts/pool#projectslist"
  />
  <Cards.Card
    icon={<Check />}
    title="ApproveButton"
    href="/contracts/pool#approvebutton"
  />
</Cards>
...
<Cards>
  <Cards.Card
    ...
    href="/contracts/pool#allocationform"
  />
  <Cards.Card
    icon={<TableProperties />}
    title="AllocationsTable"
    href="/contracts/pool#allocationstable"
  />
</Cards>
